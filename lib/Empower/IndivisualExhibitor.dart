...
class IndivisualExhibitor extends StatefulWidget {
  ...
  IndivisualExhibitor({required this.name,required this.designation,required this.description,required this.fromCommiteePage,required this.fileName, required this.linkedin, required this.venueId, required this.exhibitor, this.speakerID= ''});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  (widget.exhibitor.contactPersionName != null && widget.exhibitor.contactPersionName!.isNotEmpty)?Column(
                    children: [
                      SizedBox(height: 24),
                      InkWell(
                        onTap: (){
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.only(left: 12, right: 20),
                              child: Text(
                                widget.exhibitor.contactPersionName!,
                                style: const TextStyle(
                                  fontFamily: "Roboto",
                                  fontSize: 16,
                                  fontWeight: FontWeight.w400,
                  ...
                  SizedBox(height: 24),
                  (widget.exhibitor.emailAndPhone != null && widget.exhibitor.emailAndPhone!.split('\n')[0].isNotEmpty)?InkWell(
                    onTap: (){
                      HelperClass.makePhoneCall(widget.exhibitor.emailAndPhone!.split('\n')[0]);
                    },
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        ...
                        Container(
                          margin: EdgeInsets.only(left: 12, right: 20),
                          child: Text(
                            widget.exhibitor.emailAndPhone!.split('\n')[0],
                            style: const TextStyle(
                              fontFamily: "Roboto",
                              fontSize: 16,
                              fontWeight: FontWeight.w400,
                  ...
                  SizedBox(height: 24),
                  (widget.exhibitor.emailAndPhone != null && widget.exhibitor.emailAndPhone!.split('\n')[1].isNotEmpty)?InkWell(
                    onTap: (){
                      HelperClass.sendMailto(email:widget.exhibitor.emailAndPhone!.split('\n')[1]);
                    },
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
