...
class OutBuildingData{
  ...
  static Future<OutBuildingModel?> outBuildingData(double latitude1,double longitude1,double latitude2,double longitude2) async{
   ...
   String refreshToken = signInBox.get("refreshToken");
    ...
    var request = http.Request('POST', Uri.parse(kDebugMode? 'https://maps.iwayplus.in/secured/outdoor-wayfinding/' : 'https://maps.iwayplus.in/secured/outdoor-wayfinding/'));
